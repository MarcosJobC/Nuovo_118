...
public class Amministratore {
    ...
    // Costruttore
    public Amministratore(int matricola, String nome, String cognome, String datadinascita, String qualifica, String codiceFiscale, String password, Boolean isAdmin) {
